...
check("banner shows the tagline and version", t.saw("terminal coding agent") and t.saw("v0.1.0"), t)
...
check("modal shows key hints", t2.saw("yes, once") and t2.saw("no"), t2)
t2.send("y")
...
check("welcome shows the tagline", t8.saw("terminal coding agent"), t8)
check("welcome offers a tip", t8.saw("tip"), t8)
t8.send("explain @vie")
