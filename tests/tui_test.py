...
t = Tui(ws, ["-y"])
spaces.append(ws)
# The opening titles cover the screen for about 2 s, then dissolve into it.
t.read(5.0, until="ask, or /help for commands")
t.read(1.0)
check("the intro hands the screen over", t.wait_for(lambda s: "ask, or /help for commands" in s), t)
t.read(4.0, until="ready")  # past the ~2.5 s intro
...
spaces.append(ws2)
t2 = Tui(ws2)
t2.read(4.0, until="ready")  # past the ~2.5 s intro
...
spaces.append(ws5)
t5 = Tui(ws5)
t5.read(4.0, until="ready")  # past the ~2.5 s intro
...
t4.read(4.0, until="ready")  # past the ~2.5 s intro
...
t6.read(4.0, until="ready")  # past the ~2.5 s intro
...
t7.read(4.0, until="ready")  # past the ~2.5 s intro
...
spaces.append(ws3)
t3 = Tui(ws3)
t3.read(4.0, until="ready")  # past the ~2.5 s intro
t3.send("/")
